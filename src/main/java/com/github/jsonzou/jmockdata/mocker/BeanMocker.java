...
public class BeanMocker implements Mocker<Object> {
    ...
    private boolean isSupportMock(DataConfig mockConfig, Field field) {
        ...
        boolean isUnSuppotModifier = Modifier.isFinal(field.getModifiers()) || Modifier.isNative(field.getModifiers()) || Modifier.isVolatile(field.getModifiers()) || Modifier.isInterface(field.getModifiers()) || Modifier.isTransient(field.getModifiers()) || field.isSynthetic();
